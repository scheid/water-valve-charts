...
function WaterValveChartAlt(config) {
...
WaterValveChartAlt.prototype.drawDiagTopDown = function(d) {
...
//this is essentially a recreation of d3.diagonal, as it is not in d3v4
WaterValveChartAlt.prototype.drawDiagLeftRight = function(d) {
...
WaterValveChartAlt.prototype.generateUUID = function() {
 ...
 * @returns {string}
 */
WaterValveChartAlt.prototype.generateStatement = function() {
 ...
 * @returns {Array}
 */
WaterValveChartAlt.prototype.getLayout = function() {
 ...
 * */
WaterValveChartAlt.prototype.render = function(config) {
    ...
    groups.selectAll(".group-item")
        ...
        .attr("rx", 4)
        .attr("ry", 4)
        .attr("x", function(d, i) { return (d.groupStartMarker || d.groupEndMarker) ? d.x - (8/2) : d.x - (nodeWidth/2)  })
        .attr("y", function(d, i) { return (d.groupStartMarker || d.groupEndMarker) ? d.y - (8/2) : d.y - (nodeHeight/2)  })
        .attr("width", function(d, i) { return (d.groupStartMarker || d.groupEndMarker) ? 8 : nodeWidth})
        .attr("height", function(d, i) { return (d.groupStartMarker || d.groupEndMarker) ? 8 : nodeHeight})
